...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/htmllistparse-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7130&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/htmllistparse-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `htmllistparse` can be installed with:

```
conda install htmllistparse
```

It is possible to list all of the versions of `htmllistparse` available on your platform with:
